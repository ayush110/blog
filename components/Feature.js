        ...
        <div class="mt-12 mx-5 md:flex md:justify-center md:relative md:inline-block">
              ...
              <div class="md:flex md:inline-block md:absolute justify-center  ">
                    ...
                    <div class=" md:inline-block text-center md:text-left self-center mx-auto ">
                        ...
                        <Link href="about" ><a class=" inline-block text-sm px-4 py-2 leading-none border rounded-full text-white bg-black border-black hover:border-stone-400 hover:text-stone-400 hover:bg-transparent mt-4  sm:mt-8">Find out more</a></Link>
                    </div>
